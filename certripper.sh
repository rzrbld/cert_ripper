...
▀███▀  ▀███▀     █     ▀            █    ▐  █     █    ▀███▀     █
                ▀                  ▀         ▀     ▀            ▀
"
   echo "example: ./certripper.sh -k=/home/esb/wso2esb-4.8.1/repository/resources/security -p=wso2carbon -h=example.com:443 -n=example.com"
   echo "------";
   echo "explain:"
...
do
  ...
  keytool -importcert -file $f -keystore ${KEYPATH}/client-truststore.jks -alias '$f-$(timestamp)' -noprompt -storepass ${KEYPASS}
done
